...
<body class="bg-rose-50 text-rose-900">
    ...
    <main>
        <!-- ===== Bagian Beranda (Hero) ===== -->
        <!-- UPDATE: Mengganti gambar placeholder dengan gambar Unsplash yang lebih relevan -->
                    ...
                    <form id="order-form">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                <!-- FIX: Mengganti onclick="showQrisModal()" dengan "toggleQrisModal()" -->
                                ...
                                <!-- FIX: Mengganti onclick="payWithDana()" dengan "toggleDanaModal()" -->
    ...
    <!-- FIX: Mengganti SVG yang kompleks/rusak dengan SVG WhatsApp standar -->
    ...
    <div id="cart-modal" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 hidden">
        <div class="bg-white w-full max-w-lg rounded-2xl shadow-xl overflow-hidden">
            <div class="flex justify-between items-center p-6 border-b border-rose-100">
                ...
                <!-- FIX: Mengganti &times; dengan SVG Ikon X -->
